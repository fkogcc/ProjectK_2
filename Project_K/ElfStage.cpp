...
{
	// テクスチャ情報
	const char* kFileName = "Data/Image/Stage/elf/elf.png";
	const char* kBgFileName = "Data/Image/Stage/elf/Background.png";
...
int ElfStage::MapRead()
{
	// csvファイルを読み込んで数字の配列にしたい

	FILE* fp;

	errno_t error = fopen_s(&fp, "Data/Image/Stage/elf/elf.csv", "r");
