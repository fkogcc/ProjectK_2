...
void LogoRotation::Draw()
{
	...
	DrawFormatString(static_cast<int>(m_pos.x), static_cast<int>(m_pos.y), 0x000000, "m_pos = %f",m_pos.x);
	DrawFormatString(static_cast<int>(m_logoPos.x), static_cast<int>(m_logoPos.y), 0x000000, "m_logoPos = %f", m_logoPos.x);
}
